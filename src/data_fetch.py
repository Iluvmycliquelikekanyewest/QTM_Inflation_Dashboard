...
# Rest of your DataFetcher class code remains the same...
class DataFetcher:
    ...
    def get_fred_gdp_components(self, start_date='1990-01-01'):
        ...
        gdp_series_map = {
            ...
            'PNFIC96': 'PNFIC96',      # Equipment (Real)
            ...
            # Removed NEWORDER - no longer scaling manufacturing data
